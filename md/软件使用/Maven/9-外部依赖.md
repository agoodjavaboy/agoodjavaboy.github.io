...
现在，如你所知道的，Maven的依赖管理使用的是**Maven仓库**的概念。但是如果在远程仓库和中央仓库中，依赖不能被满足，如何解决呢? Maven 使用外部依赖的概念来解决这个问题。
...
![external-project-structure](media/11-external-project-structure.jpg)
